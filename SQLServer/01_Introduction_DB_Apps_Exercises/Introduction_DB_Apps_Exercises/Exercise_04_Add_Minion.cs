namespace Introduction_DB_Apps_Exercises
{
    ...
    class Exercise_04_Add_Minion
    {
        static void Main()
        {
            ...
            //I wanted DB to validate the data which we insert\n
            // and added triggers to activate instead of insert.
            //Basically i do only insert and triggers handle the rest.
            //Triggers throw message if data exist and i\n
            // think they implicitly have XACT_ABORT on (for ROLLBACK).
            //I don't have CONSTRAINT UNIQUE(MinionId, VillainId) and\n
            // checking if villain with minion exist.
            //английския ми е много зле (също като българския)
...
Integrated Security=true;");
            ...
            string query_TriggerInsertMinion = File.ReadAllText(
                "../../trigger_InsertMinion_exercise_4.sql");
            ...
            string query_TriggerInsertTowns = File.ReadAllText(
                "../../trigger_InsertTowns_exercise_4.sql");
            ...
            string query_TriggerInsertVillains = File.ReadAllText(
                "../../trigger_InsertVillains_exercise_4.sql");
            ...
            string query_TriggerInsertMinionsVillains = File.ReadAllText(
                "../../trigger_InsertMinionVillain_exercise_4.sql");
            ...
            string query_InsertMinionVillain = File.ReadAllText(
                "../../InsertMinionVillain_exercise_4.sql");
