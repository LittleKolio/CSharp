namespace Forum.App.Controllers
{
    ...
    public class SignUpController : IController, IReadUserInfoController
	{
        ...
        public MenuState ExecuteCommand(int index)
        {
            ...
            {
                case Command.ReadUsername: this.ReadUsername(); return MenuState.Signup;
                case Command.ReadPassword: this.ReadPassword(); return MenuState.Signup;
                case Command.SignUp:
                    {
                ...
                case Command.Back: this.ResetSignUp(); return MenuState.Back;
            }
