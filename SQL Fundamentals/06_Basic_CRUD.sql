...
SELECT FirstName + ' ' + SUBSTRING(MiddleName, 1, 1) + ' ' + LastName AS 'Full Name'
...
SELECT FirstName + ' ' +
CASE WHEN MiddleName IS NULL THEN LastName
ELSE MiddleName + ' ' + LastName END AS 'Full Name', JobTitle AS 'Job Title'
FROM Employees;
*/
CREATE VIEW V_EmployeeNameJobTitle AS
SELECT
